...
tabtitle: Rotodynamic Centrifugal Pump Curves | Head, Power, Efficiency, NPSHR vs flow | HI Data Tool 
date: August 31, 2026
...
A **pump performance curve** is a graphical representation of the head generated by a specific pump model at rates of flow from zero to maximum at a given operating speed. this section depicts curves for pump total head, efficiency, input power, and net positive suction head required (NPSHR) as a function of flow rate. Equations are provided for power and efficiency related to flow rate, head and specific gravity. It should be noted that the liquid viscosity will affect the pump total head, flow, efficiency, NPSHR and power, which is not discussed here. Refer to <a href="https://www.pumps.org/what-we-do/standards/?pumps-search-product=9.6.7&hi-order=asc&hi-order-by=name" target="_blank">ANSI/HI 9.6.7</a> for effects of liquid viscosity on rotodynamic pump performance.
...
at the specified flow rate, speed, and pumped liquid. NPSHR is further defined in <a href="/pump-fundamentals/pump-principles.html" target="self">Pump Principles.</a> 
...
Affinity rules describe the relationship of the pump performance curve (flow, head, and power) relative to pump rotational speed (or frequency) changes and limited changes in impeller diameter. 
...
Refer to <a href="https://www.pumps.org/what-we-do/standards/?pumps-search-product=14.3&hi-order=asc&hi-order-by=name" target="_blank">ANSI/HI 14.3</a> regarding limitations in using the affinity rules for impeller diameter and speed changes.
...
of two or more pumps operating in parallel, at each head value, the flow rate of each pump must be added together to obtain the composite flow rate.
...
system curve at different operating points yielding different flow rates. As more pumps are called to operate, the flow will increase accordingly:
...
A pump designed with a <units us = "10-5/8” diameter impeller will be operating at 2000 GPM @ 80 ft. During installation it was found the total head was 67 ft." metric = "270  mm diameter impeller will be operating at 454 m^3^/h @ 24.38 m. During installation it was found the total head was 20.42 m."></units>
